...
const Layout: React.FC<LayoutProps> = ({ children, activeView, setActiveView, onLogout }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-transparent">
      ...
      {/* Desktop Navigation */}
      <nav className="hidden md:flex w-24 lg:w-72 flex-col border-r border-[var(--border)] bg-[var(--nav-bg)] backdrop-blur-xl h-screen sticky top-0 p-6">
        <div className="mb-12">
          <div className="bg-[var(--border)] text-white p-6 chunky-card !shadow-none !border-0 rotate-[-2deg] mb-8 cursor-pointer" onClick={() => setActiveView('feed')}>
        ...
        <div className="space-y-4 flex-1">
          ...
          <NavItem isActive={activeView === 'room'} onClick={() => setActiveView('room')} label="Portal" icon={<svg className="w-6 h-6 nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z"></path></svg>} />
        </div>
        ...
        <div className="mt-auto space-y-4">
          ...
          >
            ...
            <div className="hidden lg:block text-left">
              ...
              <p className="text-[9px] font-bold opacity-40 uppercase">Universal Link</p>
            </div>
          </button>
        </div>
      </nav>
